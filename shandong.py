...
prefs = {'profile.default_content_settings.popups': 0, 'download.default_directory': 'D:\\download\\worm\\jinan'}
options.add_experimental_option('prefs', prefs)

bro = webdriver.Chrome(executable_path='./chromedriver', options=options)
bro.maximize_window()  # 第一种加载完成后最大化

bro.get('http://zwfw.sd.gov.cn/JIS/front/login.do?uuid=kSwamUMs12k2&gotourl=http%3A%2F%2Fdata.sd.gov.' \
...
while 1:
    ...
    for url in url_list:
        ...
        for file in filenames:
            ...
            with open('D:\\download\\worm\\jinan\\json\\shandong.json', 'a', encoding='utf-8') as f:
