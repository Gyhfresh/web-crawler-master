...
def shanxi(path):
    for year in range(2019, 2021):
        logger.info('现在爬取的是山西第' + str(year) + '年的统计年鉴')
        # 领域/不限
        url = 'http://tjj.shanxi.gov.cn/tjsj/tjnj/nj{}/zk/indexce.htm'.format(year)
...
if __name__ == '__main__':
    path = os.path.dirname(__file__) + '/../info/山西年鉴.json'
