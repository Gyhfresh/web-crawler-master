...
info_log = Logger('../log/gansu_info.log','info')
error_log = Logger('../log/gansu_error.log','info')
                ...
                if 'xls' in file.a.get('href') or 'xlrx' in file.a.get('href'):
                    ...
                    if osp.exists(path):
                       pass
                        ...
                        error_log.logger.error('这文件都不存在啊')
                        continue
                    ...
                    if osp.exists(newpath) and not osp.exists(path):
                        ...
                        error_log.logger.error('！！！！！！！！！！！！！！！！！没找到文件:{}'.format(newpath))
                        error_time = 0
                        while(True):
                            time.sleep(1)
                            error_time +=1
                    ...
                    with open('../info/gansu.json', "w", encoding='utf-8') as f:
