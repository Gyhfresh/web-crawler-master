...
def beijing(url, path):
    logger.info('现在爬取的是北京第' + str(year) + '年的统计年鉴')
...
if __name__ == '__main__':
    ...
    for year in range(2015, 2021):
        url = 'http://nj.tjj.beijing.gov.cn/nj/main/{}-tjnj/zk/indexce.htm'.format(year)
        path = os.path.dirname(__file__) + '/../info/北京年鉴.json'
        beijing(url, path)
