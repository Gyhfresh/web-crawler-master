...
def liaoning(path):
    for year in range(2014, 2020):
        logger.info('现在爬取的是辽宁第' + str(year) + '年的统计年鉴')
        # 领域/不限
        # http://tjj.ln.gov.cn/tjsj/sjcx/ndsj/otherpages/2014/zk/indexch.htm
        url = 'http://tjj.ln.gov.cn/tjsj/sjcx/ndsj/otherpages/{}/zk/indexce.htm'.format(year)
...
if __name__ == '__main__':
    path = os.path.dirname(__file__) + '/../info/辽宁年鉴.json'
    liaoning(path)
