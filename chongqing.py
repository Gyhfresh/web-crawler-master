...
def main():
    ...
    '''
    year_list = sorted(list(range(2000, 2020, 1)), reverse=True)
    download_dir = r'C:\Users\边策\Desktop\移动的项目\chongqing\data'
    ...
    for year in year_list:
        base_url = 'http://tjj.cq.gov.cn/zwgk_233/tjnj/{}/indexce.htm'.format(2018)
        driver.get(base_url)
        ...
        for topic in topic_list:
            ...
            for file in file_list:
                if 'xls' in file.a.get('href') or 'xlrx' in file.a.get('href'):
                    ...
                    with open('chongqing.json', "w", encoding='utf-8') as f:
